                        ...
                        <div className="page-header__content">
                            <div className="row justify-center text-center">
                                <div className="col-lg-9 col-md-10">
                                    <div>
                                        <h1 className="page-header__title lh-14">App Features</h1>
                                    </div>
                                </div>
                            ...
                            <div className="row y-gap-32">
                                <div className="col-lg-3 col-sm-6">
                                    <div className="py-50 px-40 bg-white rounded-16 shadow-card">
                                        ...
                                        <Link href="/features" className="button -simple text-accent fw-600 underline mt-12">Learn More</Link>
                                    </div>
                                </div>
                                <div className="col-lg-3 col-sm-6">
                                    <div className="py-50 px-40 bg-white rounded-16 shadow-card">
                                ...
                                <div className="col-lg-3 col-sm-6">
                                    <div className="py-50 px-40 bg-white rounded-16 shadow-card">
                                        ...
                                        <p className="mt-10">There is no one universal solution in online marketing.</p>
                                        <Link href="/features" className="button -simple text-accent fw-600 underline mt-12">Discover Now</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="container">
                            <div className="row y-gap-48 items-center">
                                ...
                                <div className="col-xl-5 offset-xl-1 col-md-10 col-lg-6">
                                    ...
                                    <div className="mt-30">
                                        <Link href="/features" className="button -md -accent text-white -uppercase">
                                            Get Started
                                        </Link>
                                    </div>
                                </div>
