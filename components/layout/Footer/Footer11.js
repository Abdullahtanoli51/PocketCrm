                            ...
                            <div className="col-lg-2 col-sm-6">
                                <div className="footer__item">
                                    ...
                                    <div className="footer__content y-gap-10 mt-40">
                                        ...
                                        <div className="footer__content__item text-white ">
                                            <Link className="decoration-none" href="/about">About</Link>
                                        </div>
                                       
                                       
                                        <div className="footer__content__item text-white">
                                            <Link className="decoration-none" href="/features">Features</Link>
                                        </div>
                                        <div className="footer__content__item text-white">
                                            <Link className="decoration-none" href="pricing">Pricing</Link>
                                        </div>
                                        <div className="footer__content__item text-white">
                                            <Link className="decoration-none" href="/contact">Contact</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
