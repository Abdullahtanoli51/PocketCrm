  ...
  return (
    <>
      ...
      <div className="col-lg-4 col-md-6">
          <Link
            href="/blog_detail"
            className="d-block bg-white shadow-card decoration-none rounded-8"
          >
            <div className="ratio ratio-37:25 rounded-8">
              <img
                className="absolute-full-center object-fit-cover"
        ...
        <div className="col-lg-4 col-md-6">
          ...
          >
            ...
            <div className="py-30 px-28">
              <p className="d-block decoration-none mb-8">November 23, 2023</p>
              <h3 className="text-xl lh-16 fw-600">
                Win buyers and influence sales with marketing
              </h3>
            </div>
          </Link>
        </div>
        ...
        <div className="col-lg-4 col-md-6">
          ...
          >
            ...
            <div className="py-30 px-28">
              <p className="d-block decoration-none mb-8">November 23, 2023</p>
              <h3 className="text-xl lh-16 fw-600">
                Remote workers, here is how to dodge distractions
              </h3>
            </div>
          </Link>
        </div>
        ...
        <div className="col-lg-4 col-md-6">
          ...
          >
            ...
            <div className="py-30 px-28">
              <p className="d-block decoration-none mb-8">November 23, 2023</p>
              <h3 className="text-xl lh-16 fw-600">
                Problems everyone has when working remotely and how to solve
                them
              </h3>
            </div>
          </Link>
